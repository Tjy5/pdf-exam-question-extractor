...
使用示例：
    from src.common import get_ppstructure, load_meta, crop_and_save
    from src.common.types import QUESTION_HEAD_PATTERN
    from src.common.paths import page_index
"""
